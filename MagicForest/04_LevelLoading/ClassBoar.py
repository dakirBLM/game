...
class Boar(pygame.sprite.Sprite):
    ...
    def __init__(self, position, moveRight=True):
        super().__init__()
        img_path = SPRITESHEET_PATH + "Mob/Boar/Run/Run-Sheet.png"
        try:
        ...
        if not self.frames:
            ...
            pygame.draw.rect(surf, (90, 30, 30), surf.get_rect())
            self.frames = [surf]
        ...
        # load hit/vanish or dead frames for killing
        dead_path = SPRITESHEET_PATH + "Mob/Boar/Hit-Vanish/Hit-Sheet.png"
        self.dead_frames = []
        try:
    ...
    def update(self, level):
        ...
        # animate or single static walk image
